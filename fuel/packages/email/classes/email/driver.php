...
abstract class Email_Driver {
	 ...
	 *
	 * @param
	 *        	bool Whether to validate the addresses, falls back to config setting
	 *        	
	...
	public function send($validate = null) {
		...
		$this->set_header ( 'From', static::format_addresses ( array (
				$this->config ['from'] 
		) ) );
